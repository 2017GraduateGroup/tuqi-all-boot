...
public class UserQuery extends BaseQuery implements Serializable {
     ...
     */
        ...
        public Criteria andUserNameLike(String value) {
            ...
            addCriterion("user_name like", strValue, "userName");
            return (Criteria) this;
        }

        public Criteria andUserNameNotLike(String value) {
            String strValue = "%"+value.toString()+"%";
            addCriterion("user_name not like", strValue, "userName");
            return (Criteria) this;
        }
        ...
        public Criteria andUserNickNameLike(String value) {
            String strValue = "%"+value.toString()+"%";
            addCriterion("user_nick_name like", strValue, "userNickName");
            return (Criteria) this;
        }

        public Criteria andUserNickNameNotLike(String value) {
            String strValue = "%"+value.toString()+"%";
            addCriterion("user_nick_name not like", strValue, "userNickName");
            return (Criteria) this;
        }
        ...
        public Criteria andUserTypeLike(Integer value) {
            String strValue = "%"+value.toString()+"%";
            addCriterion("user_type like", strValue, "userType");
            return (Criteria) this;
        }

        public Criteria andUserTypeNotLike(Integer value) {
            String strValue = "%"+value.toString()+"%";
            addCriterion("user_type not like", strValue, "userType");
            return (Criteria) this;
        }
